...
public interface IDao <T> extends Remote{
    ...
    List<T> findByName(String name) throws RemoteException;
    T findByNameNotLike(String name) throws RemoteException;
    List<T> findByMultiple(String name,String home,int id) throws RemoteException;
